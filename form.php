...
//Creación del XML del repositorio con SimpleXML
$repositorio = new SimpleXMLElement("<lpp:repositorio xmlns:lpp=\"http://www.uned.es/lpp\"></lpp:repositorio>");

//Iteración de cada una de las imágenes que componen el repositorio
for ($i = 1; $i <= $_POST['imagens']; ++$i) {
    //Creación del nodo de imagen
    $imagen = $repositorio->addChild('imagen');
    $imagen->addAttribute('id', $i);

    //Creación de rectángulos con sus atributos
    ...
    //Creación de líneas con sus atributos
    ...
    //Creación de círculos con sus atributos
    ...
    //Creación de elipses con sus atributos
    ...
    //Creación de polígonos con sus atributos
    ...
    //Creación de polilíneas con sus atributos
...
//Envío para su descarga por el navegador en XML
